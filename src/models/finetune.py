...
def finetune(args):
    ...
    if args.method == "ZSCL":
        ...
        elif args.ref_dataset in ["ImageNet"]:
            ref_dataset = ref_dataset_cls(
                test_preprocess,
                location=CL_DATA_LOCATION,
                batch_size=args.batch_size,
    ...
    for iteration in progress_bar:
        ...
        if args.l2 > 0:
            ...
            loss_dict['l2_loss'] = loss_l2.item()
        ...
        if args.method == "ZSCL":
            ...
            ref_batch_acc = (logits_current.argmax(dim=-1) == ref_labels).float().mean().item()
            ...
            if args.image_loss:
                if args.weight_adjust:
                    ...
                    loss_dict['image_distill_loss'] = loss_ZSCL .item()
            ...
            if args.text_loss:
                ...
                if args.weight_adjust:
                    ...
                    loss += loss_ZSCL_2
                    loss_dict['text_distill_loss'] = loss_ZSCL_2.item()
        ...
        if (args.we or args.moving_avg or args.we_wise) and iteration % args.avg_freq == 0:
            ...
            if args.moving_avg:
                ...
                # path = os.path.join(args.save, f"{args.train_dataset}_{str(we_n)}.pth")
